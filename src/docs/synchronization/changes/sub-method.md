- **type**: The method that was used to authorize the transaction.
  Currently <code class="hljs-string">"card"</code> or
...
- **card**: Data identifying the credit card used. Note that all
  ...
  - **exp**: A [Unix timestamp](https://en.wikipedia.org/wiki/Unix_time)
    denoting the expected last possible valid use time of the card.
